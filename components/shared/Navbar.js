    ...
    <div className="container px-6 py-4 mx-auto">
        <div className="lg:flex lg:items-center lg:justify-between">
            <div className="flex items-center justify-between">
                <a href="#">
                <span className="bg-[#6765F0] text-white text-sm font-medium  px-4 py-1 rounded dark:bg-blue-900 dark:text-blue-300">GYM</span> <span className='text-[#6765F0]'>baran</span>
                </a>
